...
C     
C     Process: u~ u > t t~ QCD<=2 WEIGHTED<=2 [ all = QCD ]
C     Process: c~ c > t t~ QCD<=2 WEIGHTED<=2 [ all = QCD ]
C     Process: d~ d > t t~ QCD<=2 WEIGHTED<=2 [ all = QCD ]
C     Process: s~ s > t t~ QCD<=2 WEIGHTED<=2 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
