...
C     
C     Process: u~ u > t t~ g WEIGHTED<=3 [ all = QCD ]
C     Process: c~ c > t t~ g WEIGHTED<=3 [ all = QCD ]
C     Process: d~ d > t t~ g WEIGHTED<=3 [ all = QCD ]
C     Process: s~ s > t t~ g WEIGHTED<=3 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_2(W(1,4),W(1,5),GC_5,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_5,AMP(3))
      CALL FFV1_1(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,8),W(1,7),GC_5,AMP(4))
      CALL FFV1_2(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,8),W(1,1),W(1,7),GC_5,AMP(5))
