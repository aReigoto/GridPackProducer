...
C     CutTools call for loop numbers 6
      CALL LOOP_2(5,6,DCMPLX(MDL_MB),DCMPLX(MDL_MB),2,I_SO,5)
C     CutTools call for loop numbers 7
      CALL LOOP_2(5,6,DCMPLX(MDL_MT),DCMPLX(MDL_MT),2,I_SO,6)
