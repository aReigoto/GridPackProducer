...
C     
C     Process: u~ g > t t~ u~ WEIGHTED<=3 [ all = QCD ]
C     Process: c~ g > t t~ c~ WEIGHTED<=3 [ all = QCD ]
C     Process: d~ g > t t~ d~ WEIGHTED<=3 [ all = QCD ]
C     Process: s~ g > t t~ s~ WEIGHTED<=3 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,6),W(1,7),GC_5,AMP(1))
      CALL FFV1P0_3(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_5,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,8),W(1,6),GC_5,AMP(2))
      CALL FFV1_2(W(1,4),W(1,2),GC_5,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_5,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,6),W(1,2),W(1,7),GC_4,AMP(4))
      CALL FFV1_2(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,1),W(1,7),GC_5,AMP(5))
