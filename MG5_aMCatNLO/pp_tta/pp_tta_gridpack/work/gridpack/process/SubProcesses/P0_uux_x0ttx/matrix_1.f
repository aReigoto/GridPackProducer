...
C     
C     Process: u u~ > x0 t t~ g QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: c c~ > x0 t t~ g QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: d d~ > x0 t t~ g QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: s s~ > x0 t t~ g QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_2(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,13))
      CALL FFV1P0_3(W(1,13),W(1,2),GC_5,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,8),W(1,11),GC_5,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_5,AMP(10))
      CALL FFV1_1(W(1,2),W(1,6),GC_5,ZERO,ZERO,W(1,11))
      CALL FFV1P0_3(W(1,1),W(1,11),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,8),W(1,6),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,12),W(1,4),W(1,6),GC_5,AMP(12))
      JAMP(1)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)
     $ +1D0/3D0*AMP(6)+1D0/3D0*AMP(7)+1D0/3D0*AMP(8))
      JAMP(2)=+1D0/2D0*(-AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(5)-AMP(6)-AMP(7)
     $ -AMP(9)-AMP(10))
      JAMP(3)=+1D0/2D0*(+IMAG1*AMP(2)-AMP(3)-AMP(4)+IMAG1*AMP(5)-AMP(8)
     $ -AMP(11)-AMP(12))
      JAMP(4)=+1D0/2D0*(+1D0/3D0*AMP(9)+1D0/3D0*AMP(10)+1D0/3D0*AMP(11)
     $ +1D0/3D0*AMP(12))
      MATRIX_1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
