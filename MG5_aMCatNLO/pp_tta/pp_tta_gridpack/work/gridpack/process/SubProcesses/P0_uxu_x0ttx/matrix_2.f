...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,6),W(1,1),GC_5,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,2),W(1,9),GC_5,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 12
      ...
      JAMP(1)=+1D0/2D0*(-AMP(1)-AMP(2)-AMP(3)-AMP(4)+IMAG1*AMP(9)
     $ -AMP(10)+IMAG1*AMP(11))
      JAMP(2)=+1D0/2D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0*AMP(5)
     $ +1D0/3D0*AMP(6)+1D0/3D0*AMP(10)+1D0/3D0*AMP(12))
      JAMP(3)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(7)
     $ +1D0/3D0*AMP(8))
      JAMP(4)=+1D0/2D0*(-AMP(5)-AMP(6)-AMP(7)-AMP(8)-IMAG1*AMP(9)
     $ -IMAG1*AMP(11)-AMP(12))
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
