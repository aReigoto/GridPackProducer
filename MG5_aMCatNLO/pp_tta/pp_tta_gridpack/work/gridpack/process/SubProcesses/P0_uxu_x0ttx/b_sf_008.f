...
C     ----------
     ...
     $   //' only with calculatedborn = true'
      ...
      ELSEIF (CALCULATEDBORN) THEN
        ...
        ENDDO
      ENDIF
      JAMP1(1)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2))
      JAMP1(2)=+1D0/2D0*(+AMP(1)+AMP(2))
      JAMP2(1)=+1D0/8D0*(-AMP(1)+1D0/9D0*AMP(1)-AMP(2)+1D0/9D0*AMP(2))
      JAMP2(2)=+1D0/8D0*(+3D0*AMP(1)-1D0/3D0*AMP(1)+3D0*AMP(2)-1D0/3D0
     $ *AMP(2))
      B_SF_008 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
