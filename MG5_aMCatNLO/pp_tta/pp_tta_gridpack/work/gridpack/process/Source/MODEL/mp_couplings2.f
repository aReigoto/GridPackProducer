...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $ /MP__MDL_MU_R__EXP__2),KIND=16)),KIND=16))
      MP__UV_X0TT_H = -((MP__MDL_COSA*MP__MDL_KHTT*MP__MDL_COMPLEXI
     $ *MP__MDL_YT)/MP__MDL_SQRT__2)*MP__MDL_UV_YUK_T_FIN_
      MP__UV_X0TT_A = MP__MDL_SINA*MP__MDL_KATT*MP__MDL_YT
     $ /MP__MDL_SQRT__2*MP__MDL_UV_YUK_T_FIN_
      MP__R2_TTX0_H = (-((MP__MDL_COSA*MP__MDL_KHTT*MP__MDL_COMPLEXI
     $ *MP__MDL_YT)/MP__MDL_SQRT__2))*(2.000000E+00_16
     $ *MP__MDL_R2MIXEDFACTOR_FIN_)
      MP__R2_TTX0_A = (MP__MDL_SINA*MP__MDL_KATT*MP__MDL_YT
     $ /MP__MDL_SQRT__2)*(2.000000E+00_16*MP__MDL_R2MIXEDFACTOR_FIN_)
      MP__R2_GGX0_HB = (-((MP__MDL_COSA*MP__MDL_KHBB*MP__MDL_COMPLEXI
     $ *MP__MDL_YB)/MP__MDL_SQRT__2))*(MP__MDL_G__EXP__2/(8.000000E
     $ +00_16*MP__PI**2))*MP__MDL_MB
      MP__R2_GGX0_HT = (-((MP__MDL_COSA*MP__MDL_KHTT*MP__MDL_COMPLEXI
     $ *MP__MDL_YT)/MP__MDL_SQRT__2))*(MP__MDL_G__EXP__2/(8.000000E
     $ +00_16*MP__PI**2))*MP__MDL_MT
      MP__UV_X0TT_H_1EPS = -((MP__MDL_COSA*MP__MDL_KHTT
     $ *MP__MDL_COMPLEXI*MP__MDL_YT)/MP__MDL_SQRT__2)
     $ *MP__MDL_UV_YUK_T_1EPS_
      MP__UV_X0TT_A_1EPS = MP__MDL_SINA*MP__MDL_KATT*MP__MDL_YT
