...
module collier_global
  ...
  character(len=5) :: version_cll="1.2.1"
!  character(len=5) :: version_cll=" 1.2 "
  ...
  double precision :: dprec_cll, reqacc_cll, critacc_cll, checkacc_cll
  ...
  integer, allocatable :: PointsCntTN_cll(:),CritPointsCntTN_cll(:),AccPointsCntTN_cll(:)
  integer, allocatable :: PointsCntTNten_cll(:),CritPointsCntTNten_cll(:),AccPointsCntTNten_cll(:)
!  integer :: PointsCntTN_cll(10),CritPointsCntTN_cll(10),AccPointsCntTN_cll(10)
  ...
  integer, allocatable :: PointsCntTN2_cll(:),CritPointsCntTN2_cll(:),AccPointsCntTN2_cll(:)
