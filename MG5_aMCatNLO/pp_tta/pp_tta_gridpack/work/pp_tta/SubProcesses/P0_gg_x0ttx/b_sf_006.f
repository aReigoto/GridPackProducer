...
C     ----------
     ...
     $ *IMAG1*AMP(2)-1D0/3D0*IMAG1*AMP(2)-3D0*AMP(3)+1D0/3D0*AMP(3)
     $ -3D0*AMP(4)+1D0/3D0*AMP(4)-3D0*AMP(8)+1D0/3D0*AMP(8))
      JAMP2(2)=+1D0/4D0*(-3D0*IMAG1*AMP(1)+1D0/3D0*IMAG1*AMP(1)-3D0
     $ *IMAG1*AMP(2)+1D0/3D0*IMAG1*AMP(2)-3D0*AMP(5)+1D0/3D0*AMP(5)
     $ -3D0*AMP(6)+1D0/3D0*AMP(6)-3D0*AMP(7)+1D0/3D0*AMP(7))
      B_SF_006 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR2
