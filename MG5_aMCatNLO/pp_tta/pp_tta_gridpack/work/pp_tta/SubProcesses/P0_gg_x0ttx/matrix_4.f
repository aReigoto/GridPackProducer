...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,11),W(1,10),GC_5,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,9),W(1,10),GC_5,AMP(4))
      CALL FFV1_2(W(1,5),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,9))
      CALL FFS1_5_2(W(1,9),W(1,3),GC_3010H,GC_3010A,MDL_MT,MDL_WT,W(1
     $ ,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,4),W(1,10),GC_5,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,9),W(1,8),W(1,10),GC_5,AMP(6))
      CALL FFV1_2(W(1,6),W(1,1),GC_5,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,9),W(1,2),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,8),W(1,6),GC_5,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,4),W(1,6),GC_5,AMP(8))
      CALL VVV1P0_1(W(1,1),W(1,10),GC_4,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,8),W(1,6),GC_5,AMP(9))
      CALL FFV1_1(W(1,8),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,5),W(1,9),W(1,10),GC_5,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,4),W(1,6),GC_5,AMP(11))
      CALL FFV1_2(W(1,7),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,6))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,4),W(1,10),GC_5,AMP(12))
      JAMP(1)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(5)+AMP(6)+IMAG1*AMP(9)
     $ +IMAG1*AMP(11)+AMP(12))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(7)
     $ -1D0/3D0*AMP(8))
      JAMP(3)=+1D0/2D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)-1D0/3D0*AMP(5)
     $ -1D0/3D0*AMP(6)-1D0/3D0*AMP(10)-1D0/3D0*AMP(12))
      JAMP(4)=+1D0/2D0*(+AMP(3)+AMP(4)+AMP(7)+AMP(8)-IMAG1*AMP(9)
     $ +AMP(10)-IMAG1*AMP(11))
      MATRIX_4 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
