...
C     
C     Process: d g > x0 t t~ d QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: u g > x0 t t~ u QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: s g > x0 t t~ s QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     Process: c g > x0 t t~ c QNP<=1 WEIGHTED<=5 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_2(W(1,5),W(1,9),GC_5,MDL_MT,MDL_WT,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFS1_5_0(W(1,11),W(1,10),W(1,3),GC_3010H,GC_3010A,AMP(3))
...
C     Amplitude(s) for diagram number 5
      CALL FFS1_5_0(W(1,10),W(1,12),W(1,3),GC_3010H,GC_3010A,AMP(5))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,6),W(1,2),GC_5,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 12
      ...
      JAMP(1)=+1D0/2D0*(-AMP(1)-AMP(2)-AMP(3)-AMP(4)-IMAG1*AMP(7)
     $ -AMP(8)-IMAG1*AMP(9))
      JAMP(2)=+1D0/2D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0*AMP(5)
     $ +1D0/3D0*AMP(6)+1D0/3D0*AMP(8)+1D0/3D0*AMP(10))
      JAMP(3)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(11)
     $ +1D0/3D0*AMP(12))
      JAMP(4)=+1D0/2D0*(-AMP(5)-AMP(6)+IMAG1*AMP(7)+IMAG1*AMP(9)
     $ -AMP(10)-AMP(11)-AMP(12))
      MATRIX_3 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
