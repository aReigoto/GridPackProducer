...
C     
C     Process: g g > x0 t t~ QNP<=1 WEIGHTED<=4 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      INTEGER IJ_VALUES(8)
      DATA IJ_VALUES /1, 2, 4, 5, 1, 1, 2, 2/
C     
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(8), JAMP2(0:2)
...
C           Amplitude(s) for diagram number 3
            CALL FFS1_5_0(W(1,9),W(1,6),W(1,3),GC_3010H,GC_3010A,AMP(3)
     $       )
C           Amplitude(s) for diagram number 4
            CALL FFV1_0(W(1,8),W(1,6),W(1,2),GC_5,AMP(4))
            CALL FFV1_2(W(1,5),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,6))
            CALL FFV1_1(W(1,4),W(1,2),GC_5,MDL_MT,MDL_WT,W(1,5))
C           Amplitude(s) for diagram number 5
            CALL FFS1_5_0(W(1,6),W(1,5),W(1,3),GC_3010H,GC_3010A,AMP(5)
     $       )
