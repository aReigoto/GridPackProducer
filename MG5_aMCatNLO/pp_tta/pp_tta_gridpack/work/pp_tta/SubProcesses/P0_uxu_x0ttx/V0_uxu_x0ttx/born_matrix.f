...
C     
C     Process: u~ u > x0 t t~ QCD<=2 QED<=1 QNP=0 WEIGHTED<=4 [ all =
C      QCD ]
C     Process: c~ c > x0 t t~ QCD<=2 QED<=1 QNP=0 WEIGHTED<=4 [ all =
C      QCD ]
C     Process: d~ d > x0 t t~ QCD<=2 QED<=1 QNP=0 WEIGHTED<=4 [ all =
C      QCD ]
C     Process: s~ s > x0 t t~ QCD<=2 QED<=1 QNP=0 WEIGHTED<=4 [ all =
C      QCD ]
C     
      IMPLICIT NONE
C     
...
C     JAMPs contributing to orders QCD=2
      JAMP(1,1)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2))
      JAMP(2,1)=+1D0/2D0*(+AMP(1)+AMP(2))
