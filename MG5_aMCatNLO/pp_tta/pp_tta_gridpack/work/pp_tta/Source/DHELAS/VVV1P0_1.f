...
C     
     ...
     $ * W1))
      V1(5)= DENOM*(TMP4*(-CI*(P2(0))+CI*(P3(0)))+(V2(5)*(-CI*(TMP0)
     $ +CI*(TMP1))+V3(5)*(-CI*(TMP9)+CI*(TMP8))))
      V1(6)= DENOM*(TMP4*(-CI*(P2(1))+CI*(P3(1)))+(V2(6)*(-CI*(TMP0)
     $ +CI*(TMP1))+V3(6)*(-CI*(TMP9)+CI*(TMP8))))
      V1(7)= DENOM*(TMP4*(-CI*(P2(2))+CI*(P3(2)))+(V2(7)*(-CI*(TMP0)
     $ +CI*(TMP1))+V3(7)*(-CI*(TMP9)+CI*(TMP8))))
      V1(8)= DENOM*(TMP4*(-CI*(P2(3))+CI*(P3(3)))+(V2(8)*(-CI*(TMP0)
